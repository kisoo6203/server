...
<link href="${rootPath}/static/css/home.css?ver2021-05-20-00" rel="stylesheet"/>
<style>
...
<style>
	...
	section#main {
		...
		padding:5px;
		background:linear-gradient(to right,green,white,green,white,green) ;
	...
	btutton tag는 한 라인에 배치하기 위하여
	display type inlineblock으로 변환하고
	width를 제한하여 설정하였다
	*/
	section#main form {
	...
	section#main button {
		...
		border: 0;
		border-radius: 5px;
		background-color: rgb(80, 42, 185);
		opacity:1;
		color:white;
		
	}
	section#main button:hover {
		box-shadow: 2px 2px 2px rgab(0,0,0,0,0);
