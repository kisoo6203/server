...
<style>
	...
	*/
	* {
		box-sizing: border-box; /* 모든 박스의 사이즈를 지정한다 */
	}
	...
	*/
	...
	input {
		border : 1px solid green;
		padding : 8px;
		width : 60%; /* form태그 내에서 60퍼를 차지하는 박스크기로 만든다 */
		border-radius: 10px; /* 박스 테두리를 뭉툭하게 만든다 */
	}
	a {
		text_decoration : none;
		/*
		스타일의 상속
		나(a tag)를 감싸고 있는 (td tag)의 color가
		변경되면 나도 따라 바뀔래
		*/
		color: inherit;
	}
...
<body>
	...
	input placeholder : 입력박스의 안내메시지 
	 --%>
		<p><label>식품명</label><input name="f_name"placeholder="식품명을 입력한 후 Enter...">
		</p>
