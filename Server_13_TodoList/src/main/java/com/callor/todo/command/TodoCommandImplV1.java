...
public class TodoCommandImplV1 implements TodoCommand{
	...
	public void execute(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		log.debug("td_doit {}",td_doit);	// 10:08:26.545 [http-nio-8080-exec-4] DEBUG TODO - 점심에 생선까스
		...
		tdVO.put("name", "홍길동");
		tdVO.put("name", "이몽룡");
		tdVO.put("name", "성춘향"); // 마지막에 작성한 '성춘향'만 출력이 된다 (name)에 한개만 담을수있음!
...
//		}
		...
		// "/todo/" 라는 문자열 대신 req.getContextPath() 사용
